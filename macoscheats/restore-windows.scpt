...
set currentSettings to {w:3840, h:1980, apps:{{name:"Notes", pos:{-1919, 23}, size:{1241, 754}}, {name:"Finder", pos:{-1919, 23}, size:{600, 600}}, {name:"iTerm2", pos:{-1140, 461}, size:{1040, 418}}, {name:"Slack", pos:{-1244, 1103}, size:{1152, 846}}, {name:"Atom", pos:{-1799, 90}, size:{1657, 954}}, {name:"Messages", pos:{-1292, 1271}, size:{1011, 663}}, {name:"Google Chrome", pos:{2129, 20}, size:{1552, 915}}, {name:"Postman", pos:{-1702, 36}, size:{1552, 915}}, {name:"idea", pos:{0, 23}, size:{1920, 1057}}}}
